...
CREATE TABLE IF NOT EXISTS `games` (
  ...
  `coverImages` text COLLATE utf8mb4_unicode_ci,
...
-- Dumping data for table web204_gamestore.games: ~25 rows (approximately)
/*!40000 ALTER TABLE `games` DISABLE KEYS */;
INSERT IGNORE INTO `games` (`id`, `name`, `price`, `destination`, `releaseDate`, `images`, `coverImages`, `publisher_id`) VALUES
	(1, 'Fall Guys: Ultimate Knockout', '188.000', 'Bạn sẽ vào vai 1 hạt đậu rơi từ trên trời xuống để bắt đầu "Shows" Đó là cách Fall Guys bắt đầu trò chơi. Tối đa 60 hạt đậu với nhiều màu sắc khác nhau từ skin tự chọn. Tất cả sẽ tham gia vào từng màn game nhỏ để tìm ra người tồn tại sau cùng. 25 màn game khá đa dạng, chia thành 2 loại chơi đơn và phối hợp đồng đội. Chủ yếu là các cuộc đua vượt chướng ngại vật và một số game liên quan đến quả bóng tròn, đuổi bắt đuôi nhau. Game được lấy cảm hứng từ những gameshow thử thách trên truyền hình, vì vậy mục tiêu duy nhất của bạn sẽ chỉ là trở thành người về đích đầu tiên.Nhà phát triển Mediatonic đã nói rằng họ sẽ thêm vào các màn game mới trong tương lai. Việc trở thành cơn sốt của Fall Guys là một điều khá bất ngờ với giới chuyên môn', '2020-08-04', '["1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","7.jpg","8.jpg","9.jpg"]', NULL, 1),
	(2, 'Among Us', '69.000', 'Play with 4-10 player online or via local WiFi as you attempt to prepare your spaceship for departure, but beware as one or more random players among the Crew are Impostors bent on killing everyone!', '2018-11-17', '["1.jpg","2.jpg","3.jpg","4.jpg","5.jpg"]', NULL, 2),
	(3, 'Agrou', '139.000', 'Là một tựa game Indie mới được ra mắt trong thời gian gần đây, nhưng Agrou thu hút được lượng lớn người chơi đặc biệt là từ các Streammer nổi tiếng với lối chơi vô cùng vui nhộn của mình.​', '2020-07-25', '["1.jpeg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","7.jpg","8.jpg","9.jpg"]', NULL, 3),
	(4, 'Dead by Daylight', '187.000', 'Dead by Daylight là 1 game nhiều người chơi (1 vs 4). 1 tựa game horror survivor , Dead by Daylight đem lại cho bạn những cảm giác như trong những phim kinh dị mỹ đình đám 1 thời.Với mỗi lần tiếng tim đập,hoặc tiếng âm nhạc dồn dập là 1 lần bạn thót tim và chạy không quay đầu lại.', '2016-06-14', '["1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","7.jpg","8.jpg","9.jpg"]', NULL, 4),
	(5, 'Black Desert', '23.000', 'Bạn sẽ vào vai 1 hạt đậu rơi từ trên trời xuống để bắt đầu "Shows" Đó là cách Fall Guys bắt đầu trò chơi. Tối đa 60 hạt đậu với nhiều màu sắc khác nhau từ skin tự chọn. Tất cả sẽ tham gia vào từng màn game nhỏ để tìm ra người tồn tại sau cùng. 25 màn game khá đa dạng, chia thành 2 loại chơi đơn và phối hợp đồng đội. Chủ yếu là các cuộc đua vượt chướng ngại vật và một số game liên quan đến quả bóng tròn, đuổi bắt đuôi nhau. Game được lấy cảm hứng từ những gameshow thử thách trên truyền hình, vì vậy mục tiêu duy nhất của bạn sẽ chỉ là trở thành người về đích đầu tiên.Nhà phát triển Mediatonic đã nói rằng họ sẽ thêm vào các màn game mới trong tương lai. Việc trở thành cơn sốt của Fall Guys là một điều khá bất ngờ với giới chuyên môn', '2019-09-18', '["1.png","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","7.jpg"]', NULL, 5),
	(6, 'Game name', '9999', 'Descrition', '2020-10-02', '["1.jpg","2.jpg","3.jpg"]', '["7.png","6.jpg","8.jpg"]', 1),
	(7, 'Game name', '9999', 'Descrition', '2020-10-02', '', '', 1),
	(8, '1231', '120', '123', '2020-10-02', '', '', 1),
	(9, '123', '123', '123', '2020-10-02', '["1.jpg","2.jpg","3.jpg"]', '["7.png","6.jpg","8.jpg"]', 1),
	(10, '123', '3123', '123', '2020-10-02', '["75ae5484624a1dc6feed58173e0af4ad-xbox360.png"]', '["75ae5484624a1dc6feed58173e0af4ad-xboxone.png"]', 2),
	(11, '123', '123', '123', '2020-10-02', '["2.jpg","1.jpg","3.jpg"]', '["7.png","6.jpg","8.jpg"]', 1),
	(12, '31231231', '23123123123123', '12312312313123123123', '2020-10-02', '', '', 1),
	(13, '31231231', '23123123123123', '12312312313123123123', '2020-10-02', '', '', 1),
	(14, 'abc', '121', '123', '2020-10-02', '', '', 1),
	(15, '123123123', '123123123123', '1231312312', '2020-10-02', '', '', 1),
	(16, '123123123', '123123123123', '1231312312', '2020-10-02', '', '', 1),
	(17, '123123123', '123123123123', '1231312312', '2020-10-02', '', '', 1),
	(18, '123123123', '123123123123', '1231312312', '2020-10-02', '', '', 1),
	(19, '123123123', '123123123123', '1231312312', '2020-10-02', '', '', 1),
	(20, '123', '119', '3123123', '2020-10-02', '', '', 1),
	(21, '123', '119', '3123123', '2020-10-02', '', '', 1),
	(22, '123', '119', '3123123', '2020-10-02', '', '', 1),
	(23, '123', '119', '3123123', '2020-10-02', '', '', 1),
	(24, 'sadfdfg', '2314', 'sdfadsgdgvdfv', '2020-10-02', '', '', 3),
	(25, '123', '123', '123', '2020-10-02', '', '', 1);
/*!40000 ALTER TABLE `games` ENABLE KEYS */;

-- Dumping structure for table web204_gamestore.game_platforms
CREATE TABLE IF NOT EXISTS `game_platforms` (
  `game_id` int(11) DEFAULT NULL,
  `platform_id` int(11) DEFAULT NULL,
  KEY `FK_game_platforms_games` (`game_id`),
  KEY `FK_game_platforms_platforms` (`platform_id`),
  CONSTRAINT `FK_game_platforms_games` FOREIGN KEY (`game_id`) REFERENCES `games` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_game_platforms_platforms` FOREIGN KEY (`platform_id`) REFERENCES `platforms` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table web204_gamestore.game_platforms: ~13 rows (approximately)
...
-- Dumping structure for table web204_gamestore.game_tags
CREATE TABLE IF NOT EXISTS `game_tags` (
  `game_id` int(11) DEFAULT NULL,
  `tag_id` int(11) DEFAULT NULL,
  KEY `FK_game_tags_games` (`game_id`),
  KEY `FK_game_tags_tags` (`tag_id`),
  CONSTRAINT `FK_game_tags_games` FOREIGN KEY (`game_id`) REFERENCES `games` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_game_tags_tags` FOREIGN KEY (`tag_id`) REFERENCES `tags` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table web204_gamestore.game_tags: ~45 rows (approximately)
...
-- Dumping data for table web204_gamestore.platforms: ~16 rows (approximately)
...
-- Dumping data for table web204_gamestore.tags: ~51 rows (approximately)
