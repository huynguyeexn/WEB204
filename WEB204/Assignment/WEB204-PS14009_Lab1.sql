...
-- Dumping data for table web204_gamestore.admin: ~1 rows (approximately)
...
INSERT IGNORE INTO `games` (`id`, `name`, `price`, `destination`, `releaseDate`, `images`, `tag_id`, `platform_id`, `publisher_id`) VALUES
	...
	(3, 'Agrou', '139.000 VNĐ', 'Là một tựa game Indie mới được ra mắt trong thời gian gần đây, nhưng Agrou thu hút được lượng lớn người chơi đặc biệt là từ các Streammer nổi tiếng với lối chơi vô cùng vui nhộn của mình.​', '2020-07-25 00:00:00', '["1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","7.jpg","8.jpg","9.jpg"]', '["1","2","3","4","5]', '["1","2","3","4"]', 3),
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  CONSTRAINT `FK__users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table web204_gamestore.orders: ~20 rows (approximately)
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
INSERT IGNORE INTO `orders` (`id`, `user_id`, `status`, `time`) VALUES
	(1, 2, 1, '2019-10-01 14:16:09'),
	(2, 8, 3, '2020-09-06 16:05:47'),
	(3, 8, 2, '2019-10-10 20:40:24'),
	(4, 2, 3, '2020-03-19 19:07:15'),
	(5, 3, 1, '2020-07-30 04:30:49'),
	(6, 3, 0, '2019-11-17 23:49:41'),
...
CREATE TABLE IF NOT EXISTS `order_items` (
  ...
  CONSTRAINT `FK_order_items_games` FOREIGN KEY (`game_id`) REFERENCES `games` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `FK_order_items_orders` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table web204_gamestore.order_items: ~20 rows (approximately)
/*!40000 ALTER TABLE `order_items` DISABLE KEYS */;
INSERT IGNORE INTO `order_items` (`order_id`, `game_id`, `quantity`) VALUES
	(1, 4, 10),
	(2, 3, 2),
	(3, 1, 1),
	(4, 2, 5),
...
CREATE TABLE IF NOT EXISTS `review` (
  ...
  KEY `user_id` (`user_id`),
  KEY `game_id` (`game_id`),
  CONSTRAINT `FK_review_games` FOREIGN KEY (`game_id`) REFERENCES `games` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `FK_review_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table web204_gamestore.review: ~0 rows (approximately)
...
-- Dumping data for table web204_gamestore.tags: ~50 rows (approximately)
...
INSERT IGNORE INTO `users` (`id`, `username`, `password`, `email`, `phone`, `created`, `birthday`) VALUES
	(1, 'jfraczek0', '5AlE9LfIxn8C', 'tbrydon0@simplemachines.org', '4946496384', '2020-04-26 00:00:00', '1991/04/16'),
	(2, 'kfinby1', 'db7UkzVRZ', 'snayshe1@businessweek.com', '2173734775', '2020-02-09 00:00:00', '1997/08/25'),
	(3, 'jculpin2', '7bufxJ', 'rgerin2@ted.com', '9471852777', '2020-01-08 00:00:00', '1992/09/23'),
	(4, 'asurgeoner3', '1nm4aXqN', 'slineen3@creativecommons.org', '6342672467', '2020-05-29 00:00:00', '1990/01/26'),
	(5, 'tpavolini4', 'gCVUTh3qxD', 'csleford4@about.me', '3684212989', '2019-11-16 00:00:00', '1999/12/10'),
	(6, 'llagde5', 'nqIWleYt', 'cmarzellano5@qq.com', '6629882506', '2020-02-29 00:00:00', '1992/07/14'),
	(7, 'gdoel6', '1MVsXdYMjSC', 'gborleace6@unc.edu', '6442327450', '2020-07-20 00:00:00', '1999/07/28'),
	(8, 'cgoade7', 'HnomegDTsWLQ', 'abalsellie7@eepurl.com', '6597382056', '2020-07-22 00:00:00', '1991/04/17'),
	(9, 'cdewey8', 'fXbziXhGvI2', 'lvansalzberger8@hao123.com', '1683825795', '2020-03-25 00:00:00', '1997/02/24'),
	(10, 'jcock9', 'C9dsyrsUG', 'fosiaghail9@4shared.com', '1607537911', '2020-06-18 00:00:00', '1994/06/21');
