            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li <?php if($ctrl == "admin"){echo "class=\"active\"";}?> >
                            <a href="admin.php">
                                <i class="fas fa-tachometer-alt"></i>Dashboard
                            </a>
                        </li>
                        <li <?php if($ctrl == "order"){echo "class=\"active\"";}?> >
                            <a href="admin.php?ctrl=order">
                                <i class="fas fa-cubes"></i>Orders
                            </a>
                        </li>
                        <li  <?php if($ctrl == "tag"){echo "class=\"active\"";}?> >
                            <a href="admin.php?ctrl=tag">
                                <i class="fas fa-tags"></i>Tags
                            </a>
                        </li>
                        <li <?php if($ctrl == "game"){echo "class=\"active\"";}?>>
                            <a href="admin.php?ctrl=game">
                                <i class="fas fa-gamepad"></i>Games
                            </a>
                        </li>
                        <li <?php if($ctrl == "user"){echo "class=\"active\"";}?> >
                            <a href="admin.php?ctrl=user">
