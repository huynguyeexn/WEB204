            ...
            <div class="header-slider game-item col-3 col-md-4">
                <div class="swiper-wrapper">
                    ...
                    <div class="responsive-image swiper-slide">
                        <img class="lazy"src="./assets/img/Rainbow-Six-Siege.jpg" alt="">
                    </div>
                    <div class="responsive-image swiper-slide">
                        <img class="lazy"src="./assets/img/Fall-Guys.jpg" alt="">
                    </div>
                    <div class="responsive-image swiper-slide">
                        <img class="lazy"src="./assets/img/the-witcher3.jpg" alt="">
                    </div>
                    <div class="responsive-image swiper-slide">
                        <img class="lazy"src="./assets/img/dead-by-daylight-switch-hero.jpg" alt="">
                    </div>
                </div>
        ...
        <div class="row">
            <div class="header-items  game-item  col-sm-4 col-md-2 col-1">
                <div class="responsive-image blur">
                    <img class="lazy"src="./assets/img/cyberpunk.jpg" alt="">
                </div>
                <div class="game-info">
                    <div class="game-name">
                        <a>cyberpunk 2077</a>
            ...
            <div class="header-items  game-item  col-sm-4 col-md-2 col-1">
                <div class="responsive-image blur">
                    <img class="lazy"src="./assets/img/gta5.png" alt="">
                </div>
                <div class="game-info">
                    <div class="game-name">
            ...
            <div class="header-items  game-item  col-sm-4 col-md-2 col-1">
                <div class="responsive-image blur">
                    <img class="lazy"src="./assets/img/those-who-remain.jpg" alt="">
                </div>
                <div class="game-info">
                    <div class="game-name">
            ...
            <div class="header-items  game-item  col-sm-4 col-md-2 col-1">
                <div class="responsive-image blur">
                    <img class="lazy"src="./assets/img/beat-saber.jpg" alt="">
                </div>
                <div class="game-info">
                    <div class="game-name">
                        <a>Beat Saber</a>
    ...
    <div class="container">
        <section class="platforms row-1 col-sm-4 ">
            <div class="col-1 col-md-2 col-sm-4">
                <a href=""><img class="lazy"src="./assets/img/ps4.png" alt=""></a>
            </div>
            <div class="col-1 col-md-2 col-sm-4">
                <a href=""><img class="lazy"src="./assets/img/xboxone.png" alt=""></a>
            </div>
            <div class="col-1 col-md-2 col-sm-4 center-center">
                <a href=""><img class="lazy"src="./assets/img/pcgamer.png" alt=""></a>
            </div>
            <div class="col-1 col-md-2 col-sm-4 center-center">
                <a href=""><img class="lazy"src="./assets/img/wii.png" alt=""></a>
            </div>
        </section>
    </div>
    <main class="container">
        <div class="top-games-list row-4">
            <div class="top-game col-1 dimgray-color">
                <img class="lazy"src="./assets/img/topgame-icon.png" alt="">
            </div>
            <div class="top-games-item game-item col-2">
                <div class="responsive-image blur">
                    <img class="lazy"src="./assets/img/borderlands3.png" alt="arma">
                </div>
                <div class="game-info">
                    <div class="game-name">
                        <a>BORDERLANDS 3</a>
            ...
            <div class="top-games-item game-item col-1">
                <div class="responsive-image blur">
                    <img class="lazy"src="./assets/img/dayz.jpg" alt="dayz">
                </div>
                <div class="game-info">
                    <div class="game-name">
                        <a>Day Z</a>
            ...
            <div class="top-games-item game-item col-2">
                <div class="responsive-image blur">
                    <img class="lazy"src="./assets/img/arma.jpg" alt="borderlands3">
                </div>
                <div class="game-info">
                    <div class="game-name">
                        <a>Arma</a>
            ...
            <div class="top-games-item game-item col-1">
                <div class="responsive-image blur">
                    <img class="lazy"src="./assets/img/horizon.jpg" alt="horizon">
                </div>
                <div class="game-info">
                    <div class="game-name">
                        <a>Horizon</a>
            ...
            <div class="top-games-item game-item col-1">
                <div class="responsive-image blur">
                    <img class="lazy"src="./assets/img/detroit.jpg" alt="detroit">
                </div>
                <div class="game-info">
                    <div class="game-name">
                        <a>Detroit</a>
            ...
            <div class="top-games-item game-item col-1">
                <div class="responsive-image blur">
                    <img class="lazy"src="./assets/img/hitman.jpg" alt="hitman">
                </div>
                <div class="game-info">
                    <div class="game-name">
                        <a>Hitman</a>
            ...
            <div class="top-games-item game-item col-1">
                <div class="responsive-image blur">
                    <img class="lazy"src="./assets/img/Far-Cry-4-Cover-2.png" alt="Far-Cry-4">
                </div>
                <div class="game-info">
                    <div class="game-name">
                        <a>Far Cry 4</a>
            ...
            <div class="top-games-item game-item col-2 row-span-2">
                <div class="responsive-image blur">
                    <img class="lazy"src="./assets/img/mavels.jpg" alt="mavels">
                </div>
                <div class="game-info">
                    <div class="game-name">
            ...
            <div class="top-games-item game-item col-1">
                <div class="responsive-image blur">
                    <img class="lazy"src="./assets/img/assassin.jpg" alt="assassin">
                </div>
                <div class="game-info">
                    <div class="game-name">
            ...
            <div class="top-games-item game-item col-1">
                <div class="responsive-image blur">
                    <img class="lazy"src="./assets/img/batman.jpg" alt="batman">
                </div>
                <div class="game-info">
                    <div class="game-name">
                        <a>Batman</a>
