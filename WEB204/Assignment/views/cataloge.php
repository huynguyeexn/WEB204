...
<body>
    ...
    <main class="container">
        <div class="cataloge-filter">
            ...
            <div class="genre-wrapper  d-inline ">
        ...
        <div class="cataloge row">
            <div class="cataloge-game col-4 col-sm-4 col-md-4">
                <div class="row">
                    <div class="cataloge-game-images col-1 col-md-1 col-sm-4">
                        <div class="responsive-image">
                            <img src="./assets/img/arma.jpg" alt="">
                        </div>
                    </div>
                    <div class="cataloge-game-info col-2 col-md-2 col-sm-4">
                        <a><h2 class="game-title">Arma</h2></a>
                        <div class="rate">
                            <span>4.5</span>
                        ...
                        <div class="game-tag">
                            ...
                            <a><span>Action-adventure</span></a>
                        </div>
                        <div class="destination">
                            <a><h3>Destination</h3></a>
                            <p>
                    ...
                    <div class="cataloge-game-button col-1 col-md-1 col-sm-4">
